...
class TheatersControllerTest < ActionController::TestCase
  ...
  test "should create theater" do
    assert_difference('Theater.count') do
      post :create, theater: { email: @theater.email, location: @theater.location, name: @theater.name, type: @theater.type }
    end
  ...
  test "should update theater" do
    put :update, id: @theater, theater: { email: @theater.email, location: @theater.location, name: @theater.name, type: @theater.type }
    assert_redirected_to theater_path(assigns(:theater))
  end
